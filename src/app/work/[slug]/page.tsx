  ...
  return (
    <main className="bg-background min-h-screen pb-24">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 mb-24">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-hairline/60">
          <div>
          ...
          <div>
            <h4 className="text-xs font-mono uppercase tracking-widest text-muted mb-2">ROLE</h4>
            <p className="text-sm font-semibold text-primary">{project.category}</p>
          </div>
        </div>
      </div>

      {/* Narrative Section (Challenge -> Approach -> Outcome) */}
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 space-y-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-t border-hairline/40 pt-16">
          ...
          <div className="md:col-span-8">
            ...
            <PillButton label="Start a Similar Project" href="/start" variant="primary" />
          </div>
        </div>
