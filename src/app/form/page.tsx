...
export default function FormPage() {
  ...
  const projectTypes = ["Web & App Design", "Development", "Branding & Identity", "3D & Motion", "Full Suite"];
          ...
          {!isSubmitted ? (
            ...
            <div className="flex flex-col items-center justify-center text-center py-12 space-y-6">
              ...
              <p className="text-sm text-muted max-w-[35ch] leading-relaxed">
                Thank you for submitting your project brief. We have received your answers and our strategy leads will prepare a proposal call in under 24 hours.
              </p>
